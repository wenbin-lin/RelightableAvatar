...
def get_rigid_transformation(poses, joints, parents, return_joints=False, return_joints_transform=False):
    """
    poses: 24 x 3
    joints: 24 x 3
    parents: 24
    ...
    if return_joints_transform:
        joints_transform = transforms.copy()
    ...
    if return_joints and return_joints_transform:
        return transforms, posed_joints, joints_transform
    elif return_joints:
